...
;(function(){ 
  ...
  md.parser = function( mdstr ) {
    ...
    // citations \n[d] links or reference
    mdstr = mdstr.replace(/^\[(\d+)\](.*?)/gm, '<br><small class=citation>[$1] <a href="$1">$2</a></small>')
    mdstr = mdstr.replace(/(.*?)((\[\d+\])+)(.|。)?$/gm, '$1<sup>$2</sup>')
